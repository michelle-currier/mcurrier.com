	...
	<div class="row">
		...
		<div class="row">
			<div class="six columns">
				...
				<h5><a href="https://eyeluster.photography/" target="_blank" title="Eye Luster Photography">Eye Luster Photography</a>
					<h5>
						<h5><a href="http://thepixelwire.com" target="_blank" title="the Pixel Wire">the Pixel Wire</a></h5>
						<h5><a href="https://essence-vercel.vercel.app/" target="_blank" title="Essence the Project">Essence the Project</a></h5>
			...
			<div class="six columns">
				...
				<p>mockups</p>
				<h5><a href="http://mcurrier.com/images/CCS_prototype.jpg" target="_blank" title="Mockups for a bidding Saas">Christina's Cleaning Service</a></h5>
				<p>Prototype for website.</p>
				<!-- <h5><a href="https://invis.io/96PN83IABE7" target="_blank" title="Mockups for a bidding Saas">Bidding Saas</a></h5>
				<p>Rush simple prototypes for a yet to be named construction project bidding SaaS.</p>
				<h5><a href="https://invis.io/B9OS9C3DMS4" target="_blank" title="Redesign for Dockett">Dockett</a></h5>
				<p>Redesign that I created in combo with material design components.</p>
				<h5><a href="https://invis.io/4KOS8ZOV5ZR" target="_blank" title="Fortress HSA app">Fortress HSA App</a></h5>
				<p>The design flats that I used for creating less from scratch for the during app creation.</p> -->
